  ...
  // 客觀題（知識檢測）- 更複雜的題目
  {
    ...
    questions: [
      ...
      },
      {
        id: 'q9_short',
        type: 'short_answer',
        content: '请结合你所学的知识，分析植物工厂为什么能实现"全年稳定生产"？请从环境控制、光照管理和营养供给三个维度进行说明。',
        answer: '植物工厂通过密闭环境完全隔绝外界气候变化，利用精确的温控系统维持最适生长温度；采用LED人工光源可按需设置光照时长和光谱，不受季节和昼夜限制；营养液循环系统精确调控EC值和pH，确保全年营养稳定供给，三者共同保障了连续稳定生产。',
        explanation: '评估要点：① 环境控制：密闭空间隔绝外界影响，温湿度精确可控；② 光照管理：人工LED光源不依赖自然光，可灵活调控光周期；③ 营养供给：水培营养液循环系统，精准调控养分浓度和pH。'
      },
      {
        id: 'q10_short',
        type: 'short_answer',
        content: '假设你是一名植物工厂工程师，某批生菜出现叶片发黄、生长迟缓的问题。请运用本课所学，提出至少三条可能的原因，并对应说明排查方案。',
        answer: '可能原因及排查：① 营养液EC值过低（缺肥）——检测EC值，若低于标准范围则补充浓缩营养液；② 光照不足或光谱不合适——检查LED灯具是否故障，核查红蓝光比例是否适合生菜生长；③ pH偏高导致铁锌等微量元素吸收受阻——测定pH，若超出5.5-6.5范围则用pH调节剂校正；④ 根系病害或溶氧不足——检查根部是否有褐变腐烂，确认循环泵和增氧装置正常运行。',
        explanation: '评估要点：① 能准确联系症状与可能成因（叶黄→缺肥/pH异常/缺光）；② 排查方案具有可操作性，有量化参考（EC值、pH范围）；③ 涉及多维度分析（营养、光照、病害、溶氧），体现系统性思维。'
      }
    ]
  },
  {
